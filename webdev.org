...
** TODO Specialty layout - flexbox [0%]
*** TODO Having content fill a container
...
*** TODO Vertical flex centering
*** TODO Flexbox style options and shorthand
*** TODO Three-column page layout
*** TODO A gallery stub
** TODO adding a blog [%]
